\section{Github}
Link for the every exercises in Lab 1: \href{https://github.com/Lmonk555/lab01_micro_process_control.git}{Link}
...
\begin{figure}[H]
    ...
    \caption{\href{https://github.com/Lmonk555/lab01_micro_process_control/blob/f27f059d8b621813454205462adaa890d0dad597/Proteus8/ex_01.pdsprj}{\textit{Proteus schematic for 2 LEDs}}}
...
\begin{figure}[H]
    ...
    \caption{{\textit{Proteus schematic for 3 LEDs}}}
...
\begin{figure}[H]
    ...
    \caption{{\textit{Proteus schematic for a 4-way traffic light}}}
    \label{schematic_ex03}
\end{figure}

- Due to the increasing of number of LEDs, we will use arrays to handle them, or struct if you prefer.
...
\begin{lstlisting}[language=c,caption={Exercise 03 source code},label={lst:ex03}]
    ...
    /* USER CODE BEGIN 2 */
        ...
        GPIO_PinState phase1[] = { SET,   SET,   RESET, RESET, SET,   SET   };
        GPIO_PinState phase2[] = { SET,   RESET, SET,   RESET, SET,   SET   };
        GPIO_PinState phase3[] = { RESET, SET,   SET,   SET,   SET,   RESET };
        GPIO_PinState phase4[] = { RESET, SET,   SET,   SET,   RESET, SET   };
...
\begin{figure}[H]
    ...
    \caption{{\textit{Proteus schematic for a 7-segment LED}}}
...
\begin{figure}[H]
    ...
    \caption{{\textit{Proteus schematic for a 4-way traffic with 7-segment LED counters}}}
...
\begin{figure}[H]
    ...
    \caption{{\textit{Proteus schematic for clock by using 12 red LEDs}}}
