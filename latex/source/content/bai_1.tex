...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{source/picture/schematic_ex01.jpg}
...
\begin{lstlisting}[caption=Exercise 01 source code in while loop]
while (1)
{
// Using HAL_GPIO_WritePin() for hard-write LEDs' state due to unknown initial states.
// Therefore, not using HAL_GPIO_TogglePin() as in example
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{source/picture/schematic_ex02.jpg}
    \caption{\href{https://github.com/Lmonk555/lab01_micro_process_control/tree/563bcd9357e134c12eeb4b0b6b0bf3eb79c213f7/Proteus8/ex_01}{\textit{Proteus schematic for 3 LEDs}}}
