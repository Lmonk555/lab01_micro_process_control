...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \draw[line width=0.5pt, color=blue!70!black]
        ([shift={(1.15cm,-1.15cm)}]current page.north west) rectangle
        ([shift={(-1.15cm,1.15cm)}]current page.south east);
\end{tikzpicture}

\begin{center}
    \vspace*{1.5cm}
    {\bfseries\large HO CHI MINH UNIVERSITY OF TECHNOLOGY}\\

    \includegraphics[width=12cm]{source/picture/01_logobachkhoa.png}\\

    {\bfseries\large FACULTY OF COMPUTER SCIENCE AND ENGINEERING}\\[0.5cm]
    {\bfseries\large COURSE: MICROPROCESSORS - MICROCONTROLLERS -- CO3010}\\[0.5cm]
    {\bfseries\large Date: 24/09/2026}\\[1cm]

    \rule{0.6\textwidth}{0.5pt}\\[0.5cm]
    {\Huge\bfseries\color{blue!70!black} LAB 1}\\[0.5cm]
    {\large\color{blue!70!black} LED Animations}\\[0.3cm]
    \rule{0.6\textwidth}{0.5pt}\\[2cm]

    \begin{flushleft}
    \hspace{2cm}\textbf{Student: Nguyễn Đức Phi Long} \\[0.6cm]
    \hspace{2cm}\textbf{Student ID: 2452689} \\[0.6cm]
    \hspace{2cm}\textbf{Class ID: CC04} 
    \end{flushleft}
\end{center}
